...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'widget_subtitle': 'Add widgets to your home screen',
      'widget_small_title': 'Small Widget (2×2)',
      'widget_small_desc': 'Shows time until next Sweet Spot',
      'widget_medium_title': 'Medium Widget (4×2)',
      'widget_medium_desc': 'Today\'s summary + Sweet Spot countdown',
      'widget_large_title': 'Large Widget (4×4)',
      'widget_large_desc': 'Full daily overview with timeline',
      'widget_lockscreen_title': 'Lock Screen Widget',
      'widget_lockscreen_desc': 'Quick glance without unlocking',
      'widget_add_instruction': 'Long press on home screen → Widgets → Lulu',
      'widget_ios_instruction': 'Long press on home screen → + button → Search "Lulu"',
      'widget_how_to_add': 'How to Add',
      'sweet_spot_in': 'in {minutes}m',
      ...
      // SLEEP RECORD SCREEN
      // ============================================
      'track_sleep_patterns': 'Track your baby\'s sleep patterns',
      'sleep_last_sleep': 'Last sleep: {time} ago',
      ...
      // ============================================
      // FEEDING RECORD SCREEN
      // ============================================
      'feeding_last_time': 'Last feeding: {time} ago',
      'amount_ml': 'Amount (ml)',
      ...
      // PLAY RECORD SCREEN
      // ============================================
      'play_context_hint': 'Select age-appropriate activities',

      // ============================================
      // PLAY POST RECORD FEEDBACK
      // ============================================
      'play_today_count': '🎮 Today\'s play: {count}',
      'play_duration_minutes': '⏱️ {minutes} min',

      // ============================================
      // HEALTH - TEMPERATURE SCREEN
      // ============================================
      'temperature_record_baby': 'Record baby\'s temperature',
      'temperature_normal_range': 'Normal: 36.5-37.5°C',
      'temperature_fever_status': '⚠️ Fever detected',
      'temperature_normal_status': '✅ Normal',
      'temperature_record_complete': 'Temperature Recorded! 🌡️',
    ...
    'ko': {
      ...
      'widget_subtitle': '홈 화면에 위젯을 추가하세요',
      'widget_small_title': '작은 위젯 (2×2)',
      'widget_small_desc': 'Sweet Spot까지 남은 시간 표시',
      'widget_medium_title': '중간 위젯 (4×2)',
      'widget_medium_desc': '오늘 요약 + Sweet Spot 카운트다운',
      'widget_large_title': '큰 위젯 (4×4)',
      'widget_large_desc': '타임라인 포함 전체 일일 현황',
      'widget_lockscreen_title': '잠금화면 위젯',
      'widget_lockscreen_desc': '잠금 해제 없이 빠르게 확인',
      'widget_add_instruction': '홈 화면 길게 누르기 → 위젯 → Lulu',
      'widget_ios_instruction': '홈 화면 길게 누르기 → + 버튼 → "Lulu" 검색',
      'widget_how_to_add': '추가 방법',
      'sweet_spot_in': '{minutes}분 후',
      ...
      // SLEEP RECORD SCREEN
      // ============================================
      'track_sleep_patterns': '수면 패턴을 추적하세요',
      'sleep_last_sleep': '마지막 수면: {time} 전',
      'sleep_status': '수면 상태',
      ...
      // FEEDING RECORD SCREEN
      // ============================================
      'feeding_last_time': '마지막 수유: {time} 전',
      'amount_ml': '양 (ml)',
      ...
      // PLAY RECORD SCREEN
      // ============================================
      'play_context_hint': '발달에 맞는 놀이 활동을 선택하세요',

      // ============================================
      // PLAY POST RECORD FEEDBACK
      // ============================================
      'play_today_count': '🎮 오늘 놀이: {count}회',
      'play_duration_minutes': '⏱️ {minutes}분',

      // ============================================
      // HEALTH - TEMPERATURE SCREEN
      // ============================================
      'temperature_record_baby': '아기의 체온을 기록하세요',
      'temperature_normal_range': '정상: 36.5-37.5°C',
      'temperature_fever_status': '⚠️ 발열 감지',
      'temperature_normal_status': '✅ 정상',
      'temperature_record_complete': '체온 기록 완료! 🌡️',
